...
abstract class CommonObject
{
     ...
     */
    public
    function showOptionals($extrafields, $mode = 'view', $params = null, $keysuffix = '', $keyprefix = '', $onetrtd = 0, $display_type = 'card')
    {
     ...
     */
    public
    static function commonReplaceThirdparty(DoliDB $db, $origin_id, $dest_id, array $tables, $ignoreerrors = 0)
    {
     ...
     */
    public
    function defineBuyPrice($unitPrice = 0.0, $discountPercent = 0.0, $fk_product = 0)
    {
        global $conf;
     ...
     */
    protected
    function isForcedToNullIfZero($info)
    {
        if (is_array($info)) {
            if (isset($info['notnull']) && $info['notnull'] == '-1') return true;
            else return false;
     ...
     */
    public
    function setVarsFromFetchObj(&$obj)
    {
     ...
     */
    protected
    function quote($value, $fieldsentry)
    {
     ...
     */
    public
    function createCommon(User $user, $notrigger = false)
    {
        global $langs;
     ...
     */
    public
    function fetchCommon($id, $ref = null, $morewhere = '')
    {
     ...
     */
    public
    function fetchLinesCommon($morewhere = '')
    {
     ...
     */
    public
    function updateCommon(User $user, $notrigger = false)
    {
        global $conf, $langs;
     ...
     */
    public
    function deleteCommon(User $user, $notrigger = false, $forcechilddeletion = 0)
    {
     ...
     */
    public
    function deleteByParentField($parentId = 0, $parentField = '')
    {
        global $user;
     ...
     */
    public
    function deleteLineCommon(User $user, $idline, $notrigger = false)
    {
        global $conf;
     ...
     */
    public
    function setStatusCommon($user, $status, $notrigger = 0, $triggercode = '')
    {
        $error = 0;
     ...
     */
    public
    function trimParameters($parameters)
    {
     ...
     */
    public
    function getCategoriesCommon($type_categ)
    {
     ...
     */
    public
    function setCategoriesCommon($categories, $type_categ = '', $remove_existing = true)
    {
     ...
     */
    public
    function deleteEcmFiles($mode = 0)
    {
        global $conf;
